...
export default function Home() {
  ...
  return <div className= "min-h-screen bg-black text-white overflow-hidden relative">
    <div className="fixed inset-0 bg-gradient-to-br from-purple-900/20 
    via-blue-900/20 to-green-900/20 animate-pulse"/>

    <div style={{
      left: mousePosition.x-192, 
      top: mousePosition.y -192,
      transition: "all 0.3s ease-out",
    }} className="fixed w-96 h-96 bg-gradient-to-r from-blue-500/20 
     to-lime-500/20 rounded full blur-3xl pointer-events-none z-0"></div>
        ...
        <div className="space-y-6 sm:space-y-8 text-center lg:text-left">
          <div className="space-y-4 sm:space-y-6">
            <h1 className="text-7xl lg:text-8xl font-black leading-none tracking-tight">
              ...
              <span className="block font-light italic text-lime-300">Publish.</span>
              <span className="block font-black bg-gradient-to-r 
              from-blue-400 via-lime-400 to-green-400 bg-clip-text text-transparent">Grow.</span>
            </h1>
            <p className="text-lg sm:text-xl md:2xl text-gray-300 font-light
             leading-relaxed max-w-2xl md:max-w-none">The AI powered platform that turns your ideas into
     ...
     <section id='features' className="relative mt-14 z-10 py-16 sm:py-24
      px-4 sm:px-6 bg-gradient-to-r from-gray-900/50 to-green-900/50">
          ...
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            ...
            mb-4 sm:mb-6">
              ...
              <p className="text-lg sm:text-xl text-gray-400 max-w-3xl mx-auto px-4">
                ...
                w&apos;ve built the complete toolkit for moderns creators.
              </p>
          </div>
              ...
              <Card 
                ...
                <CardContent className="p-6 sm:p-8">
                  <div
                    ...
                    rounded-2xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            ...
            mb-4 sm:mb-6">
              ...
              <p className="text-lg sm:text-xl text-gray-400 max-w-3xl mx-auto px-4">
                Three poweful modules working together to superchange your content creation.
              </p>
          </div>
      ...
      <section className="relative z-10 py-16 sm:py-24 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-8 sm:mb-10">
      ...
      <section className="relative z-10 py-16 sm:px-24 px-4 sm:px-6 
      bg-gradient-to-r from-gray-900/20">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black
            mb-4 sm:mb-6">
              ...
              <p className="text-lg sm:text-xl text-gray-400 max-w-3xl mx-auto px-4">
                Join thousands of creators using Creatr to build their audience
                and grow their business with AI-powered tools.
              </p>
        </div>
