...
const PostCard = ({
  ...
  return (
    <Card
      className={`card-glass hover:border-green-500/50 transition-colors ${className}`}
    >
      <CardContent>
          ...
          <div className="flex items-start justify-between mt-5">
            <div className="flex-1 min-w-0">
              ...
              <Link
                ...
                className={!publicUrl ? "pointer-events-none" : ""}
              >
                <h3 className="text-xl font-bold text-white hover:text-green-300 transition-colors line-clamp-2">
                  {post.title}
                </h3>
              </Link>
            </div>
            ...
            <div className="flex items-center space-x-3">
              <div className="relative w-8 h-8">
                {post.author.imageUrl ? (
                  ...
                  <div className="w-full h-full rounded-full bg-gradient-to-br from-lime-600 to-blue-600 flex items-center justify-center text-sm font-bold">
